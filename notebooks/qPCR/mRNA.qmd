...
# #USE GEOMETRIC MEAN when averaging normalized expression (RQ) values. They are on a multiplicative scale. 
# plot_data[,
...
# ggsave(filename = here("images/mrna_3A4_main.png"), device = "png", dpi = "retina")
```
...
# View, save, or further manipulate these plots:
plot_IL6
plot_IL1B
```
